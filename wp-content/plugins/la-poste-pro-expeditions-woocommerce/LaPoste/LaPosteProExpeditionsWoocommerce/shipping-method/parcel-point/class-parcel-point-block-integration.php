...
class Parcel_Point_Block_Integration implements IntegrationInterface {
	...
	public function initialize() {
		...
		wp_enqueue_script( 'laposteproexp_polyfills', $assets_path . '/js/polyfills.min.js', array(), '1.0.2', false );
		wp_enqueue_script( 'laposteproexp_maplibre_gl', $assets_path . '/js/maplibre-gl.js', array(), '1.0.2', false );
		wp_enqueue_script( 'laposteproexp_shipping', $assets_path . '/js/parcel-point.min.js', array( 'jquery-core', 'wp-hooks', 'wp-i18n' ), '1.0.2', false );
		wp_enqueue_style( 'laposteproexp_maplibre_gl', $assets_path . '/css/maplibre-gl.min.css', array(), '1.0.2' );
		wp_enqueue_style( 'laposteproexp_parcel_point', $assets_path . '/css/parcel-point.css', array(), '1.0.2' );
